...
for lang in dfg_function:
    LANGUAGE = Language('/home/chen/workspace/codeproject/CL4acrossVersionSC/model_OneVulSingleVersion/Peculiar/parser/my-languages.so', lang)
    parser = Parser()
...
# initialize logger
logging.config.fileConfig("/home/chen/workspace/codeproject/CL4acrossVersionSC/model_OneVulSingleVersion/Peculiar/logging05.cfg")
...
class RuntimeContext(object):
    ...
    def get_config_file_name(self):
        ...
        config_file = "/home/chen/workspace/codeproject/CL4acrossVersionSC/model_OneVulSingleVersion/Peculiar/dev05.cfg"
...
class TextDataset(Dataset):
    def __init__(self, tokenizer, args, file_path='train'):
        ...
        url_to_code = {}
        with open('/home/chen/workspace/codeproject/CL4acrossVersionSC/dataset/cross-version_dataset/cross-version_jsonl/contracts_data_05.jsonl') as f:
