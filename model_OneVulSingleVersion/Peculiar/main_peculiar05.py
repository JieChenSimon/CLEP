...
def sweep_train():
    # 创建sweep
    sweep_id = wandb.sweep(sweep=sweep_config, project="main_peculiar05")
    ...
    def train():
        ...
        # 定义配置文件和脚本路径
        cfg_file_path = '/home/chen/workspace/codeproject/CL4acrossVersionSC/model_OneVulSingleVersion/Peculiar/dev05.cfg'
        script_path = '/home/chen/workspace/codeproject/CL4acrossVersionSC/model_OneVulSingleVersion/Peculiar/detect-05_wandb.py'
