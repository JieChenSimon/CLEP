...
def sweep_train():
    # 创建sweep
    sweep_id = wandb.sweep(sweep=sweep_config, project="CLPT_05")
    ...
    def train():
        ...
        # 定义配置文件和脚本路径
        cfg_file_path = '/home/chen/workspace/codeproject/CL4acrossVersionSC/model_OneVulSingleVersion/ourCLPT/MPCSampler_SupCon/version-specific_fine-tuning/devCLPT_05.cfg'
        script_path = '/home/chen/workspace/codeproject/CL4acrossVersionSC/model_OneVulSingleVersion/ourCLPT/MPCSampler_SupCon/version-specific_fine-tuning/CLPT_05_wandb.py'
