...
reentrancy_info = read_file("/home/chen/workspace/codeproject/CL4acrossVersionSC/model_OneVulSingleVersion/conventionTools/slither_re.csv")
...
for version in ['0.5', '0.6', '0.7', '0.8']:
    ...
    for row in label_info:
        ...
        if broad_version == version:
            ...
            if reentrancy_row:
                predicted_label = reentrancy_row[3]  # 第四列是securify1标签
