...
# 路径可能需要根据您的文件系统进行调整
label_info = read_file("/home/chen/workspace/codeproject/CL4acrossVersionSC/model_OneVulSingleVersion/conventionTools/labelInfo.txt")
...
for version in ['0.5', '0.6', '0.7', '0.8']:
    ...
    for row in label_info:
        ...
        if broad_version == version:
            ...
            if reentrancy_row:
                predicted_label = reentrancy_row[5]  # 第四列是securify1标签
