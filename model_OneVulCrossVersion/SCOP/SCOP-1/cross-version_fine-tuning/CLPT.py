...
wandb.init(project="CLPR_ourSampler_SupCon_CVFT_0308")

# load parsers
parsers = {}
for lang in dfg_function:
    LANGUAGE = Language('/home/chen/workspace/codeproject/CL4acrossVersionSC/model_OneVulCrossVersion/ourCLPT/ourSampler_SupCon/cross-version_fine-tuning/parser/my-languages.so', lang)
    parser = Parser()
...
# 设置日志
logging.config.fileConfig('/home/chen/workspace/codeproject/CL4acrossVersionSC/model_OneVulCrossVersion/ourCLPT/ourSampler_SupCon/cross-version_fine-tuning/logging_CLPT_ourSampler_wandb.cfg')
...
class RuntimeContext(object):
    ...
    def get_config_file_name(self):
        ...
        config_file = "/home/chen/workspace/codeproject/CL4acrossVersionSC/model_OneVulCrossVersion/ourCLPT/ourSampler_SupCon/cross-version_fine-tuning/devCLPT_ourSampler_wandb.cfg"
...
class TextDataset(Dataset):
    def __init__(self, tokenizer, args, file_path='train'):
        ...
        with open('/home/chen/workspace/codeproject/CL4acrossVersionSC/dataset/cross-version_dataset/cross-version_jsonl_withVersionInfo/ALL_04_08.jsonl') as f:
            for line in f:
                line = line.strip()
                js = json.loads(line)
