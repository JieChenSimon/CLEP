...
def sweep_train():
    # 创建sweep
    sweep_id = wandb.sweep(sweep=sweep_config, project="CLPR_singleALLRE_sampler_hidis_wandb_v3")
    ...
    def train():
        ...
        # 定义配置文件和脚本路径
        cfg_file_path = '/home/chen/workspace/codeproject/CL4acrossVersionSC/model_OneVulCrossVersion/ourCLPT/ourSampler_ourLoss/devCLPT_ALLRESampler_hidis_wandb.cfg'
        script_path = '/home/chen/workspace/codeproject/CL4acrossVersionSC/model_OneVulCrossVersion/ourCLPT/ourSampler_ourLoss/CLPR_singleALL_crossVersionSampler_HiDis_wandb.py'
